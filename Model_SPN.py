...
Expression('EWG_nT_1', sympify("EWG_1_4_obs + EWG_2_5_obs + EWG_2_6_obs + EWG_1_1_obs + EWG_4_2_obs + EWG_4_3_obs"))
Expression('EWG_nT_2', sympify("EWG_2_4_obs + EWG_3_5_obs + EWG_3_6_obs + EWG_2_1_obs + EWG_1_2_obs + EWG_1_3_obs"))
Expression('EWG_nT_3', sympify("EWG_3_4_obs + EWG_4_5_obs + EWG_4_6_obs + EWG_3_1_obs + EWG_2_2_obs + EWG_2_3_obs"))
Expression('EWG_nT_4', sympify("EWG_4_4_obs + EWG_1_5_obs + EWG_1_6_obs + EWG_4_1_obs + EWG_3_2_obs + EWG_3_3_obs"))

Expression('Hill_CNen_1', sympify("K_CNen^nu_CNen/(K_CNen^nu_CNen + CN_1_obs^nu_CNen)"))
Expression('Hill_CNen_2', sympify("K_CNen^nu_CNen/(K_CNen^nu_CNen + CN_2_obs^nu_CNen)"))
Expression('Hill_CNen_3', sympify("K_CNen^nu_CNen/(K_CNen^nu_CNen + CN_3_obs^nu_CNen)"))
Expression('Hill_CNen_4', sympify("K_CNen^nu_CNen/(K_CNen^nu_CNen + CN_4_obs^nu_CNen)"))

Expression('Hill_EWG_nT_1', sympify("H_en*EWG_nT_1*Hill_CNen_1^nu_WGen/(K_WGen^nu_WGen + EWG_nT_1*Hill_CNen_1^nu_WGen)"))
Expression('Hill_EWG_nT_2', sympify("H_en*EWG_nT_2*Hill_CNen_2^nu_WGen/(K_WGen^nu_WGen + EWG_nT_2*Hill_CNen_2^nu_WGen)"))
Expression('Hill_EWG_nT_3', sympify("H_en*EWG_nT_3*Hill_CNen_3^nu_WGen/(K_WGen^nu_WGen + EWG_nT_3*Hill_CNen_3^nu_WGen)"))
Expression('Hill_EWG_nT_4', sympify("H_en*EWG_nT_4*Hill_CNen_4^nu_WGen/(K_WGen^nu_WGen + EWG_nT_4*Hill_CNen_4^nu_WGen)"))
...
Expression('Hill_CNwg_1', sympify("K_CNwg^nu_CNwg/(K_CNwg^nu_CNwg + CN_1_obs^nu_CNwg)"))
Expression('Hill_CNwg_2', sympify("K_CNwg^nu_CNwg/(K_CNwg^nu_CNwg + CN_2_obs^nu_CNwg)"))
Expression('Hill_CNwg_3', sympify("K_CNwg^nu_CNwg/(K_CNwg^nu_CNwg + CN_3_obs^nu_CNwg)"))
Expression('Hill_CNwg_4', sympify("K_CNwg^nu_CNwg/(K_CNwg^nu_CNwg + CN_4_obs^nu_CNwg)"))

Expression('Hill_CIwg_1', sympify("CI_1_obs*Hill_CNwg_1^nu_CIwg/(K_CIwg^nu_CIwg + CI_1_obs*Hill_CNwg_1^nu_CIwg)"))
Expression('Hill_CIwg_2', sympify("CI_2_obs*Hill_CNwg_2^nu_CIwg/(K_CIwg^nu_CIwg + CI_2_obs*Hill_CNwg_2^nu_CIwg)"))
Expression('Hill_CIwg_3', sympify("CI_3_obs*Hill_CNwg_3^nu_CIwg/(K_CIwg^nu_CIwg + CI_3_obs*Hill_CNwg_3^nu_CIwg)"))
Expression('Hill_CIwg_4', sympify("CI_4_obs*Hill_CNwg_4^nu_CIwg/(K_CIwg^nu_CIwg + CI_4_obs*Hill_CNwg_4^nu_CIwg)"))

Expression('Hill_IWGwg_1', sympify("IWG_1_obs^nu_WGwg/(K_WGwg^nu_WGwg + IWG_1_obs^nu_WGwg)"))
Expression('Hill_IWGwg_2', sympify("IWG_2_obs^nu_WGwg/(K_WGwg^nu_WGwg + IWG_2_obs^nu_WGwg)"))
Expression('Hill_IWGwg_3', sympify("IWG_3_obs^nu_WGwg/(K_WGwg^nu_WGwg + IWG_3_obs^nu_WGwg)"))
Expression('Hill_IWGwg_4', sympify("IWG_4_obs^nu_WGwg/(K_WGwg^nu_WGwg + IWG_4_obs^nu_WGwg)"))

Expression('wg_mess_1', sympify("H_wg*(alpha_CIwg*Hill_CIwg_1 + alpha_WGwg*Hill_IWGwg_1)/(1 + alpha_CIwg*Hill_CIwg_1 + alpha_WGwg*Hill_IWGwg_1)"))
Expression('wg_mess_2', sympify("H_wg*(alpha_CIwg*Hill_CIwg_2 + alpha_WGwg*Hill_IWGwg_2)/(1 + alpha_CIwg*Hill_CIwg_2 + alpha_WGwg*Hill_IWGwg_2)"))
Expression('wg_mess_3', sympify("H_wg*(alpha_CIwg*Hill_CIwg_3 + alpha_WGwg*Hill_IWGwg_3)/(1 + alpha_CIwg*Hill_CIwg_3 + alpha_WGwg*Hill_IWGwg_3)"))
Expression('wg_mess_4', sympify("H_wg*(alpha_CIwg*Hill_CIwg_4 + alpha_WGwg*Hill_IWGwg_4)/(1 + alpha_CIwg*Hill_CIwg_4 + alpha_WGwg*Hill_IWGwg_4)"))
...
Rule('degrade_EWG_1_1', EWG_1_1() >> None, H_IWG)
Rule('degrade_EWG_1_2', EWG_1_2() >> None, H_IWG)
Rule('degrade_EWG_1_3', EWG_1_3() >> None, H_IWG)
Rule('degrade_EWG_1_4', EWG_1_4() >> None, H_IWG)
Rule('degrade_EWG_1_5', EWG_1_5() >> None, H_IWG)
Rule('degrade_EWG_1_6', EWG_1_6() >> None, H_IWG)
Rule('degrade_EWG_2_1', EWG_2_1() >> None, H_IWG)
Rule('degrade_EWG_2_2', EWG_2_2() >> None, H_IWG)
Rule('degrade_EWG_2_3', EWG_2_3() >> None, H_IWG)
Rule('degrade_EWG_2_4', EWG_2_4() >> None, H_IWG)
Rule('degrade_EWG_2_5', EWG_2_5() >> None, H_IWG)
Rule('degrade_EWG_2_6', EWG_2_6() >> None, H_IWG)
Rule('degrade_EWG_3_1', EWG_3_1() >> None, H_IWG)
Rule('degrade_EWG_3_2', EWG_3_2() >> None, H_IWG)
Rule('degrade_EWG_3_3', EWG_3_3() >> None, H_IWG)
Rule('degrade_EWG_3_4', EWG_3_4() >> None, H_IWG)
Rule('degrade_EWG_3_5', EWG_3_5() >> None, H_IWG)
Rule('degrade_EWG_3_6', EWG_3_6() >> None, H_IWG)
Rule('degrade_EWG_4_1', EWG_4_1() >> None, H_IWG)
Rule('degrade_EWG_4_2', EWG_4_2() >> None, H_IWG)
Rule('degrade_EWG_4_3', EWG_4_3() >> None, H_IWG)
Rule('degrade_EWG_4_4', EWG_4_4() >> None, H_IWG)
Rule('degrade_EWG_4_5', EWG_4_5() >> None, H_IWG)
Rule('degrade_EWG_4_6', EWG_4_6() >> None, H_IWG)
...
Rule('diffuse_EWG_3_3_4_6', EWG_1_6() <> EWG_4_3(), Mxfer_WG, Mxfer_WG)
Rule('diffuse_EWG_4_1_4_4', EWG_4_1() <> EWG_4_4(), Mxfer_WG, Mxfer_WG)

#### patched mRNA (ptc)

Expression('Hill_CNptc_1', sympify("K_CNptc^nu_CNptc/(K_CNptc^nu_CNptc + CN_1_obs^nu_CNptc)"))
Expression('Hill_CNptc_2', sympify("K_CNptc^nu_CNptc/(K_CNptc^nu_CNptc + CN_2_obs^nu_CNptc)"))
Expression('Hill_CNptc_3', sympify("K_CNptc^nu_CNptc/(K_CNptc^nu_CNptc + CN_3_obs^nu_CNptc)"))
Expression('Hill_CNptc_4', sympify("K_CNptc^nu_CNptc/(K_CNptc^nu_CNptc + CN_4_obs^nu_CNptc)"))

Expression('Hill_CIptc_1', sympify("H_ptc*CI_1_obs*Hill_CNptc_1^nu_CIptc/(K_CIptc^nu_CIptc + CI_1_obs*Hill_CNptc_1^nu_CIptc)"))
Expression('Hill_CIptc_2', sympify("H_ptc*CI_2_obs*Hill_CNptc_2^nu_CIptc/(K_CIptc^nu_CIptc + CI_2_obs*Hill_CNptc_2^nu_CIptc)"))
Expression('Hill_CIptc_3', sympify("H_ptc*CI_3_obs*Hill_CNptc_3^nu_CIptc/(K_CIptc^nu_CIptc + CI_3_obs*Hill_CNptc_3^nu_CIptc)"))
Expression('Hill_CIptc_4', sympify("H_ptc*CI_4_obs*Hill_CNptc_4^nu_CIptc/(K_CIptc^nu_CIptc + CI_4_obs*Hill_CNptc_4^nu_CIptc)"))
...
Expression('Hill_CNhh_1', sympify("K_CNhh^nu_CNhh/(K_CNhh^nu_CNhh + CN_1_obs^nu_CNhh)"))
Expression('Hill_CNhh_2', sympify("K_CNhh^nu_CNhh/(K_CNhh^nu_CNhh + CN_2_obs^nu_CNhh)"))
Expression('Hill_CNhh_3', sympify("K_CNhh^nu_CNhh/(K_CNhh^nu_CNhh + CN_3_obs^nu_CNhh)"))
Expression('Hill_CNhh_4', sympify("K_CNhh^nu_CNhh/(K_CNhh^nu_CNhh + CN_4_obs^nu_CNhh)"))

Expression('Hill_ENhh_1', sympify("H_hh*EN_1_obs*Hill_CNhh_1^nu_ENhh/(K_ENhh^nu_ENhh + EN_1_obs*Hill_CNhh_1^nu_ENhh)"))
Expression('Hill_ENhh_2', sympify("H_hh*EN_2_obs*Hill_CNhh_2^nu_ENhh/(K_ENhh^nu_ENhh + EN_2_obs*Hill_CNhh_2^nu_ENhh)"))
Expression('Hill_ENhh_3', sympify("H_hh*EN_3_obs*Hill_CNhh_3^nu_ENhh/(K_ENhh^nu_ENhh + EN_3_obs*Hill_CNhh_3^nu_ENhh)"))
Expression('Hill_ENhh_4', sympify("H_hh*EN_4_obs*Hill_CNhh_4^nu_ENhh/(K_ENhh^nu_ENhh + EN_4_obs*Hill_CNhh_4^nu_ENhh)"))
...
Expression('HH_1_1_2nd_order', sympify("K_PTC_HH*max_HH*PTC_1_4_obs*HH_1_1_obs"))
Expression('HH_1_2_2nd_order', sympify("K_PTC_HH*max_HH*PTC_2_5_obs*HH_1_2_obs"))
Expression('HH_1_3_2nd_order', sympify("K_PTC_HH*max_HH*PTC_2_6_obs*HH_1_3_obs"))
Expression('HH_1_4_2nd_order', sympify("K_PTC_HH*max_HH*PTC_1_1_obs*HH_1_4_obs"))
Expression('HH_1_5_2nd_order', sympify("K_PTC_HH*max_HH*PTC_4_2_obs*HH_1_5_obs"))
Expression('HH_1_6_2nd_order', sympify("K_PTC_HH*max_HH*PTC_4_3_obs*HH_1_6_obs"))
Expression('HH_2_1_2nd_order', sympify("K_PTC_HH*max_HH*PTC_2_4_obs*HH_2_1_obs"))
Expression('HH_2_2_2nd_order', sympify("K_PTC_HH*max_HH*PTC_3_5_obs*HH_2_2_obs"))
Expression('HH_2_3_2nd_order', sympify("K_PTC_HH*max_HH*PTC_3_6_obs*HH_2_3_obs"))
Expression('HH_2_4_2nd_order', sympify("K_PTC_HH*max_HH*PTC_2_1_obs*HH_2_4_obs"))
Expression('HH_2_5_2nd_order', sympify("K_PTC_HH*max_HH*PTC_1_2_obs*HH_2_5_obs"))
Expression('HH_2_6_2nd_order', sympify("K_PTC_HH*max_HH*PTC_1_3_obs*HH_2_6_obs"))
Expression('HH_3_1_2nd_order', sympify("K_PTC_HH*max_HH*PTC_3_4_obs*HH_3_1_obs"))
Expression('HH_3_2_2nd_order', sympify("K_PTC_HH*max_HH*PTC_4_5_obs*HH_3_2_obs"))
Expression('HH_3_3_2nd_order', sympify("K_PTC_HH*max_HH*PTC_4_6_obs*HH_3_3_obs"))
Expression('HH_3_4_2nd_order', sympify("K_PTC_HH*max_HH*PTC_3_1_obs*HH_3_4_obs"))
Expression('HH_3_5_2nd_order', sympify("K_PTC_HH*max_HH*PTC_2_2_obs*HH_3_5_obs"))
Expression('HH_3_6_2nd_order', sympify("K_PTC_HH*max_HH*PTC_2_3_obs*HH_3_6_obs"))
Expression('HH_4_1_2nd_order', sympify("K_PTC_HH*max_HH*PTC_4_4_obs*HH_4_1_obs"))
Expression('HH_4_2_2nd_order', sympify("K_PTC_HH*max_HH*PTC_1_5_obs*HH_4_2_obs"))
Expression('HH_4_3_2nd_order', sympify("K_PTC_HH*max_HH*PTC_1_6_obs*HH_4_3_obs"))
Expression('HH_4_4_2nd_order', sympify("K_PTC_HH*max_HH*PTC_4_1_obs*HH_4_4_obs"))
Expression('HH_4_5_2nd_order', sympify("K_PTC_HH*max_HH*PTC_3_2_obs*HH_4_5_obs"))
Expression('HH_4_6_2nd_order', sympify("K_PTC_HH*max_HH*PTC_3_3_obs*HH_4_6_obs"))
...
Rule('PH_complex_1_1', None >> PH_1_1(), PTC_1_1_2nd_order)
Rule('PH_complex_1_2', None >> PH_1_2(), PTC_1_2_2nd_order)
Rule('PH_complex_1_3', None >> PH_1_3(), PTC_1_3_2nd_order)
Rule('PH_complex_1_4', None >> PH_1_4(), PTC_1_4_2nd_order)
Rule('PH_complex_1_5', None >> PH_1_5(), PTC_1_5_2nd_order)
Rule('PH_complex_1_6', None >> PH_1_6(), PTC_1_6_2nd_order)
Rule('PH_complex_2_1', None >> PH_2_1(), PTC_2_1_2nd_order)
Rule('PH_complex_2_2', None >> PH_2_2(), PTC_2_2_2nd_order)
Rule('PH_complex_2_3', None >> PH_2_3(), PTC_2_3_2nd_order)
Rule('PH_complex_2_4', None >> PH_2_4(), PTC_2_4_2nd_order)
Rule('PH_complex_2_5', None >> PH_2_5(), PTC_2_5_2nd_order)
Rule('PH_complex_2_6', None >> PH_2_6(), PTC_2_6_2nd_order)
Rule('PH_complex_3_1', None >> PH_3_1(), PTC_3_1_2nd_order)
Rule('PH_complex_3_2', None >> PH_3_2(), PTC_3_2_2nd_order)
Rule('PH_complex_3_3', None >> PH_3_3(), PTC_3_3_2nd_order)
Rule('PH_complex_3_4', None >> PH_3_4(), PTC_3_4_2nd_order)
Rule('PH_complex_3_5', None >> PH_3_5(), PTC_3_5_2nd_order)
Rule('PH_complex_3_6', None >> PH_3_6(), PTC_3_6_2nd_order)
Rule('PH_complex_4_1', None >> PH_4_1(), PTC_4_1_2nd_order)
Rule('PH_complex_4_2', None >> PH_4_2(), PTC_4_2_2nd_order)
Rule('PH_complex_4_3', None >> PH_4_3(), PTC_4_3_2nd_order)
Rule('PH_complex_4_4', None >> PH_4_4(), PTC_4_4_2nd_order)
Rule('PH_complex_4_5', None >> PH_4_5(), PTC_4_5_2nd_order)
Rule('PH_complex_4_6', None >> PH_4_6(), PTC_4_6_2nd_order)
...
Expression('Hill_ENci_1', sympify("K_ENci^nu_ENci/(K_ENci^nu_ENci + CN_1_obs^nu_ENci)"))
Expression('Hill_ENci_2', sympify("K_ENci^nu_ENci/(K_ENci^nu_ENci + CN_2_obs^nu_ENci)"))
Expression('Hill_ENci_3', sympify("K_ENci^nu_ENci/(K_ENci^nu_ENci + CN_3_obs^nu_ENci)"))
Expression('Hill_ENci_4', sympify("K_ENci^nu_ENci/(K_ENci^nu_ENci + CN_4_obs^nu_ENci)"))

Expression('Hill_Bci_1', sympify("H_ci*CI_1_obs*Hill_ENci_1^nu_Bci/(K_Bci^nu_Bci + CI_1_obs*Hill_ENci_1^nu_Bci)"))
Expression('Hill_Bci_2', sympify("H_ci*CI_2_obs*Hill_ENci_2^nu_Bci/(K_Bci^nu_Bci + CI_2_obs*Hill_ENci_2^nu_Bci)"))
Expression('Hill_Bci_3', sympify("H_ci*CI_3_obs*Hill_ENci_3^nu_Bci/(K_Bci^nu_Bci + CI_3_obs*Hill_ENci_3^nu_Bci)"))
Expression('Hill_Bci_4', sympify("H_ci*CI_4_obs*Hill_ENci_4^nu_Bci/(K_Bci^nu_Bci + CI_4_obs*Hill_ENci_4^nu_Bci)"))
...
Rule('degrade_CN_1', CN_1() >> None, H_CI)
Rule('degrade_CN_2', CN_2() >> None, H_CI)
Rule('degrade_CN_3', CN_3() >> None, H_CI)
Rule('degrade_CN_4', CN_4() >> None, H_CI)

# cleavage

Expression('PTC_iT_1', sympify("PTC_1_1_obs + PTC_1_2_obs + PTC_1_3_obs + PTC_1_4_obs + PTC_1_5_obs + PTC_1_6_obs"))
Expression('PTC_iT_2', sympify("PTC_2_1_obs + PTC_2_2_obs + PTC_2_3_obs + PTC_2_4_obs + PTC_2_5_obs + PTC_2_6_obs"))
Expression('PTC_iT_3', sympify("PTC_3_1_obs + PTC_3_2_obs + PTC_3_3_obs + PTC_3_4_obs + PTC_3_5_obs + PTC_3_6_obs"))
Expression('PTC_iT_4', sympify("PTC_4_1_obs + PTC_4_2_obs + PTC_4_3_obs + PTC_4_4_obs + PTC_4_5_obs + PTC_4_6_obs"))

Expression('Hill_PTCci_1', sympify("C_CI*PTC_iT_1^nu_PTCCI/(K_PTCCI^nu_PTCCI + PTC_iT_1^nu_PTCCI)"))
Expression('Hill_PTCci_2', sympify("C_CI*PTC_iT_2^nu_PTCCI/(K_PTCCI^nu_PTCCI + PTC_iT_2^nu_PTCCI)"))
Expression('Hill_PTCci_3', sympify("C_CI*PTC_iT_3^nu_PTCCI/(K_PTCCI^nu_PTCCI + PTC_iT_3^nu_PTCCI)"))
Expression('Hill_PTCci_4', sympify("C_CI*PTC_iT_4^nu_PTCCI/(K_PTCCI^nu_PTCCI + PTC_iT_4^nu_PTCCI)"))
