...
# think this is for wingless but it's more complicated than this
...
# this should probably be written as the complex itself?
...
# the [0] means that the cooperative binding actually _represses_ transcription
...
# why does X1 bind external WG from all faces? shouldn't it only be able to do one?

bind_multiple(X1_1, 'EWG', [EWG_1_4, EWG_2_5, EWG_2_6, EWG_1_1, EWG_4_2, EWG_4_3], ['X1', 'X1', 'X1', 'X1', 'X1', 'X1'],
              [X1_EWG_kf, X1_EWG_kr, X1_EWG_kf, X1_EWG_kr, X1_EWG_kf, X1_EWG_kr, X1_EWG_kf, X1_EWG_kr, X1_EWG_kf,
               X1_EWG_kr, X1_EWG_kf, X1_EWG_kr])
bind_multiple(X1_2, 'EWG', [EWG_2_4, EWG_3_5, EWG_3_6, EWG_2_1, EWG_1_2, EWG_1_3], ['X1', 'X1', 'X1', 'X1', 'X1', 'X1'],
              [X1_EWG_kf, X1_EWG_kr, X1_EWG_kf, X1_EWG_kr, X1_EWG_kf, X1_EWG_kr, X1_EWG_kf, X1_EWG_kr, X1_EWG_kf,
               X1_EWG_kr, X1_EWG_kf, X1_EWG_kr])
bind_multiple(X1_3, 'EWG', [EWG_3_4, EWG_4_5, EWG_4_6, EWG_3_1, EWG_2_2, EWG_2_3], ['X1', 'X1', 'X1', 'X1', 'X1', 'X1'],
              [X1_EWG_kf, X1_EWG_kr, X1_EWG_kf, X1_EWG_kr, X1_EWG_kf, X1_EWG_kr, X1_EWG_kf, X1_EWG_kr, X1_EWG_kf,
               X1_EWG_kr, X1_EWG_kf, X1_EWG_kr])
bind_multiple(X1_4, 'EWG', [EWG_4_4, EWG_1_5, EWG_1_6, EWG_4_1, EWG_3_2, EWG_3_3], ['X1', 'X1', 'X1', 'X1', 'X1', 'X1'],
              [X1_EWG_kf, X1_EWG_kr, X1_EWG_kf, X1_EWG_kr, X1_EWG_kf, X1_EWG_kr, X1_EWG_kf, X1_EWG_kr, X1_EWG_kf,
               X1_EWG_kr, X1_EWG_kf, X1_EWG_kr])
...
en_g_1_binding_partners = [EWG_1_4(X1=50) % X1_1(EWG=50), EWG_2_5(X1=51) % X1_1(EWG=51), EWG_2_6(X1=52) % X1_1(EWG=52),
                           EWG_1_1(X1=53) % X1_1(EWG=53), EWG_4_2(X1=54) % X1_1(EWG=54), EWG_4_3(X1=55) % X1_1(EWG=55)]
en_g_2_binding_partners = [EWG_2_4(X1=50) % X1_1(EWG=50), EWG_3_5(X1=51) % X1_1(EWG=51), EWG_3_6(X1=52) % X1_1(EWG=52),
                           EWG_2_1(X1=53) % X1_1(EWG=53), EWG_1_2(X1=54) % X1_1(EWG=54), EWG_1_3(X1=55) % X1_1(EWG=55)]
en_g_3_binding_partners = [EWG_3_4(X1=50) % X1_1(EWG=50), EWG_4_5(X1=51) % X1_1(EWG=51), EWG_4_6(X1=52) % X1_1(EWG=52),
                           EWG_3_1(X1=53) % X1_1(EWG=53), EWG_2_2(X1=54) % X1_1(EWG=54), EWG_2_3(X1=55) % X1_1(EWG=55)]
en_g_4_binding_partners = [EWG_4_4(X1=50) % X1_1(EWG=50), EWG_1_5(X1=51) % X1_1(EWG=51), EWG_1_6(X1=52) % X1_1(EWG=52),
                           EWG_4_1(X1=53) % X1_1(EWG=53), EWG_3_2(X1=54) % X1_1(EWG=54), EWG_3_3(X1=55) % X1_1(EWG=55)]
...
transcription_cooperative(en_g_1, ['EWG_X1'], [en_g_1_binding_partners], ['en_g'], [1],
                          [EWG_X1_en_g_kf, EWG_X1_en_g_kf, EWG_X1_en_g_kf, EWG_X1_en_g_kf], en_1, en_ts, en_deg)
transcription_cooperative(en_g_2, ['EWG_X1'], [en_g_2_binding_partners], ['en_g'], [1],
                          [EWG_X1_en_g_kf, EWG_X1_en_g_kf, EWG_X1_en_g_kf, EWG_X1_en_g_kf], en_2, en_ts, en_deg)
transcription_cooperative(en_g_3, ['EWG_X1'], [en_g_3_binding_partners], ['en_g'], [1],
                          [EWG_X1_en_g_kf, EWG_X1_en_g_kf, EWG_X1_en_g_kf, EWG_X1_en_g_kf], en_3, en_ts, en_deg)
transcription_cooperative(en_g_4, ['EWG_X1'], [en_g_4_binding_partners], ['en_g'], [1],
                          [EWG_X1_en_g_kf, EWG_X1_en_g_kf, EWG_X1_en_g_kf, EWG_X1_en_g_kf], en_4, en_ts, en_deg)
...
# again should not be cooperative here
...
# cooperative here is correct though
...
transcription_cooperative(wg_g_1, ['X'], [[X2_1, X3_1]], ['wg_g'], [1],
                          [X2_wg_g_kf, X2_wg_g_kr, X3_wg_g_kf, X3_wg_g_kr], wg_1, wg_ts, wg_deg)
transcription_cooperative(wg_g_2, ['X'], [[X2_2, X3_2]], ['wg_g'], [1],
                          [X2_wg_g_kf, X2_wg_g_kr, X3_wg_g_kf, X3_wg_g_kr], wg_2, wg_ts, wg_deg)
transcription_cooperative(wg_g_3, ['X'], [[X2_3, X3_3]], ['wg_g'], [1],
                          [X2_wg_g_kf, X2_wg_g_kr, X3_wg_g_kf, X3_wg_g_kr], wg_3, wg_ts, wg_deg)
transcription_cooperative(wg_g_4, ['X'], [[X2_4, X3_4]], ['wg_g'], [1],
                          [X2_wg_g_kf, X2_wg_g_kr, X3_wg_g_kf, X3_wg_g_kr], wg_4, wg_ts, wg_deg)
...
exo_endo(IWG_1, [EWG_1_1, EWG_1_2, EWG_1_3, EWG_1_4, EWG_1_5, EWG_1_6],
         [WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo])
exo_endo(IWG_2, [EWG_2_1, EWG_2_2, EWG_2_3, EWG_2_4, EWG_2_5, EWG_2_6],
         [WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo])
exo_endo(IWG_3, [EWG_3_1, EWG_3_2, EWG_3_3, EWG_3_4, EWG_3_5, EWG_3_6],
         [WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo])
exo_endo(IWG_4, [EWG_4_1, EWG_4_2, EWG_4_3, EWG_4_4, EWG_4_5, EWG_4_6],
         [WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo, WG_exo, WG_endo])
...
face_to_face_pairs = [[EWG_1_4, EWG_1_1], [EWG_2_5, EWG_1_2], [EWG_2_6, EWG_1_3], [EWG_1_1, EWG_1_4],
                      [EWG_4_2, EWG_1_5], [EWG_4_3, EWG_1_6], [EWG_2_4, EWG_2_1], [EWG_3_5, EWG_2_2],
                      [EWG_3_6, EWG_2_3], [EWG_2_1, EWG_2_4], [EWG_1_2, EWG_2_5], [EWG_1_3, EWG_2_6], \
                      [EWG_3_4, EWG_3_1], [EWG_4_5, EWG_3_2], [EWG_4_6, EWG_3_3], [EWG_3_1, EWG_3_4],
                      [EWG_2_2, EWG_3_5], [EWG_2_3, EWG_3_6], [EWG_4_4, EWG_4_1], [EWG_1_5, EWG_4_2],
                      [EWG_1_6, EWG_4_3], [EWG_4_1, EWG_4_4], [EWG_3_2, EWG_4_5], [EWG_3_3, EWG_4_6]]
...
EWG_list = [EWG_1_1, EWG_1_2, EWG_1_3, EWG_1_4, EWG_1_5, EWG_1_6, EWG_2_1, EWG_2_2, EWG_2_3, EWG_2_4, EWG_2_5, EWG_2_6,
            EWG_3_1, EWG_3_2, EWG_3_3, EWG_3_4, EWG_3_5, EWG_3_6, EWG_4_1, EWG_4_2, EWG_4_3, EWG_4_4, EWG_4_5, EWG_4_6]
...
transcription_cooperative(ptc_g_1, ['CI_X4'], [CI_1(X4=50) % X4_1(CI=50)], ['ptc_g'], [1],
                          [CI_X4_ptc_g_kf, CI_X4_ptc_g_kf], ptc_1, ptc_ts, ptc_deg)
transcription_cooperative(ptc_g_2, ['CI_X4'], [CI_2(X4=50) % X4_2(CI=50)], ['ptc_g'], [1],
                          [CI_X4_ptc_g_kf, CI_X4_ptc_g_kf], ptc_2, ptc_ts, ptc_deg)
transcription_cooperative(ptc_g_3, ['CI_X4'], [CI_3(X4=50) % X4_3(CI=50)], ['ptc_g'], [1],
                          [CI_X4_ptc_g_kf, CI_X4_ptc_g_kf], ptc_3, ptc_ts, ptc_deg)
transcription_cooperative(ptc_g_4, ['CI_X4'], [CI_4(X4=50) % X4_4(CI=50)], ['ptc_g'], [1],
                          [CI_X4_ptc_g_kf, CI_X4_ptc_g_kf], ptc_4, ptc_ts, ptc_deg)
...
transcription_cooperative(ci_g_1, ['B_X5'], [B_1(X5=50) % X5_1(B=50)], ['ci_g'], [1], [B_X5_ci_g_kf, B_X5_ci_g_kf],
                          ci_1, ci_ts, ci_deg)
transcription_cooperative(ci_g_2, ['B_X5'], [B_2(X5=50) % X5_2(B=50)], ['ci_g'], [1], [B_X5_ci_g_kf, B_X5_ci_g_kf],
                          ci_2, ci_ts, ci_deg)
transcription_cooperative(ci_g_3, ['B_X5'], [B_3(X5=50) % X5_3(B=50)], ['ci_g'], [1], [B_X5_ci_g_kf, B_X5_ci_g_kf],
                          ci_3, ci_ts, ci_deg)
transcription_cooperative(ci_g_4, ['B_X5'], [B_4(X5=50) % X5_4(B=50)], ['ci_g'], [1], [B_X5_ci_g_kf, B_X5_ci_g_kf],
                          ci_4, ci_ts, ci_deg)
...
transcription_cooperative(x6_g_1, ['PTC'], [x6_g_1_binding_partners], ['x6_g'], [1], [PTC_x6_g_kf, PTC_x6_g_kf], x6_1,
                          x6_ts, x6_deg)
transcription_cooperative(x6_g_2, ['PTC'], [x6_g_2_binding_partners], ['x6_g'], [1], [PTC_x6_g_kf, PTC_x6_g_kf], x6_2,
                          x6_ts, x6_deg)
transcription_cooperative(x6_g_3, ['PTC'], [x6_g_3_binding_partners], ['x6_g'], [1], [PTC_x6_g_kf, PTC_x6_g_kf], x6_3,
                          x6_ts, x6_deg)
transcription_cooperative(x6_g_4, ['PTC'], [x6_g_4_binding_partners], ['x6_g'], [1], [PTC_x6_g_kf, PTC_x6_g_kf], x6_4,
                          x6_ts, x6_deg)
...
Rule('Bind_CI_X6_1', CI_1(X4=None, ptc_g=None, X6=None) + X6_1(CI=None) <> CI_1(X4=None, ptc_g=None, X6=1) % X6_1(CI=1),
     CI_X6_kf, CI_X6_kr)
Rule('Bind_CI_X6_2', CI_2(X4=None, ptc_g=None, X6=None) + X6_2(CI=None) <> CI_2(X4=None, ptc_g=None, X6=1) % X6_2(CI=1),
     CI_X6_kf, CI_X6_kr)
Rule('Bind_CI_X6_3', CI_3(X4=None, ptc_g=None, X6=None) + X6_3(CI=None) <> CI_3(X4=None, ptc_g=None, X6=1) % X6_3(CI=1),
     CI_X6_kf, CI_X6_kr)
Rule('Bind_CI_X6_4', CI_4(X4=None, ptc_g=None, X6=None) + X6_4(CI=None) <> CI_4(X4=None, ptc_g=None, X6=1) % X6_4(CI=1),
     CI_X6_kf, CI_X6_kr)
...
Rule('Cleave_CI_1',
     CI_1(X4=None, ptc_g=None, X6=1) % X6_1(CI=1) >> CN_1(x1_g=None, x2_g=None, x4_g=None, x7_g=None) + X6_1(CI=None),
     Cleave_CI)
Rule('Cleave_CI_2',
     CI_2(X4=None, ptc_g=None, X6=1) % X6_2(CI=1) >> CN_2(x1_g=None, x2_g=None, x4_g=None, x7_g=None) + X6_2(CI=None),
     Cleave_CI)
Rule('Cleave_CI_3',
     CI_3(X4=None, ptc_g=None, X6=1) % X6_3(CI=1) >> CN_3(x1_g=None, x2_g=None, x4_g=None, x7_g=None) + X6_3(CI=None),
     Cleave_CI)
Rule('Cleave_CI_4',
     CI_4(X4=None, ptc_g=None, X6=1) % X6_4(CI=1) >> CN_4(x1_g=None, x2_g=None, x4_g=None, x7_g=None) + X6_4(CI=None),
     Cleave_CI)
...
transcription_cooperative(hh_g_1, ['EN_X7'], [EN_1(X7=50) % X7_1(EN=50)], ['hh_g'], [1], [EN_X7_hh_g_kf, EN_X7_hh_g_kf],
                          hh_1, hh_ts, hh_deg)
transcription_cooperative(hh_g_2, ['EN_X7'], [EN_2(X7=50) % X7_2(EN=50)], ['hh_g'], [1], [EN_X7_hh_g_kf, EN_X7_hh_g_kf],
                          hh_2, hh_ts, hh_deg)
transcription_cooperative(hh_g_3, ['EN_X7'], [EN_3(X7=50) % X7_3(EN=50)], ['hh_g'], [1], [EN_X7_hh_g_kf, EN_X7_hh_g_kf],
                          hh_3, hh_ts, hh_deg)
transcription_cooperative(hh_g_4, ['EN_X7'], [EN_4(X7=50) % X7_4(EN=50)], ['hh_g'], [1], [EN_X7_hh_g_kf, EN_X7_hh_g_kf],
                          hh_4, hh_ts, hh_deg)
...
Rule('test1',CN_1(x1_g=None, x2_g=None, x4_g=None, x7_g=None)+CN_1(x1_g=None, x2_g=None, x4_g=None, x7_g=None)>>CN_1(x1_g=None, x2_g=0, x4_g=None, x7_g=None)%CN_1(x1_g=0, x2_g=None, x4_g=None, x7_g=None),PH_deg)
Rule('test2',CN_1(x1_g=None, x2_g=0, x4_g=None, x7_g=None)%CN_1(x1_g=0, x2_g=None, x4_g=None, x7_g=None)+CN_1(x1_g=None, x2_g=None, x4_g=None, x7_g=None)>>CN_1(x1_g=None, x2_g=0, x4_g=None, x7_g=None)%CN_1(x1_g=0, x2_g=1, x4_g=None, x7_g=None)%CN_1(x1_g=1, x2_g=None, x4_g=None, x7_g=None),PH_deg)
Rule('test3',CN_1(x1_g=None, x2_g=0, x4_g=None, x7_g=None)%CN_1(x1_g=0, x2_g=1, x4_g=None, x7_g=None)%CN_1(x1_g=1, x2_g=None, x4_g=None, x7_g=None)+CN_1(x1_g=None, x2_g=None, x4_g=None, x7_g=None)>>CN_1(x1_g=None, x2_g=0, x4_g=None, x7_g=None)%CN_1(x1_g=0, x2_g=1, x4_g=None, x7_g=None)%CN_1(x1_g=1, x2_g=2, x4_g=None, x7_g=None)%CN_1(x1_g=2, x2_g=None, x4_g=None, x7_g=None),PH_deg)
Rule('test4',CN_1(x1_g=None, x2_g=0, x4_g=None, x7_g=None)%CN_1(x1_g=0, x2_g=1, x4_g=None, x7_g=None)%CN_1(x1_g=1, x2_g=2, x4_g=None, x7_g=None)%CN_1(x1_g=2, x2_g=None, x4_g=None, x7_g=None)+CN_1(x1_g=None, x2_g=None, x4_g=None, x7_g=None)>>CN_1(x1_g=None, x2_g=0, x4_g=None, x7_g=None)%CN_1(x1_g=0, x2_g=1, x4_g=None, x7_g=None)%CN_1(x1_g=1, x2_g=2, x4_g=None, x7_g=None)%CN_1(x1_g=2, x2_g=3, x4_g=None, x7_g=None)%CN_1(x1_g=3, x2_g=None, x4_g=None, x7_g=None),PH_deg)
Rule('test5',CN_1(x1_g=None, x2_g=0, x4_g=None, x7_g=None)%CN_1(x1_g=0, x2_g=1, x4_g=None, x7_g=None)%CN_1(x1_g=1, x2_g=2, x4_g=None, x7_g=None)%CN_1(x1_g=2, x2_g=3, x4_g=None, x7_g=None)%CN_1(x1_g=3, x2_g=None, x4_g=None, x7_g=None)+CN_1(x1_g=None, x2_g=None, x4_g=None, x7_g=None)>>CN_1(x1_g=None, x2_g=0, x4_g=None, x7_g=None)%CN_1(x1_g=0, x2_g=1, x4_g=None, x7_g=None)%CN_1(x1_g=1, x2_g=2, x4_g=None, x7_g=None)%CN_1(x1_g=2, x2_g=3, x4_g=None, x7_g=None)%CN_1(x1_g=3, x2_g=4, x4_g=None, x7_g=None)%CN_1(x1_g=4, x2_g=None, x4_g=None, x7_g=None),PH_deg)
